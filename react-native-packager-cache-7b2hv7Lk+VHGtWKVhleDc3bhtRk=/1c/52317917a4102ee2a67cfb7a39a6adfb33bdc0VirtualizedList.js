...
var _class,
    _temp,
    _initialiseProps,
    _jsxFileName = '/mnt/c/Users/Daniel/Naviago-RN-Frontend/node_modules/react-native/Libraries/Lists/VirtualizedList.js';
...
var _reactTransformHmrLibIndexJs2 = (0, _index3.default)({
  filename: '/mnt/c/Users/Daniel/Naviago-RN-Frontend/node_modules/react-native/Libraries/Lists/VirtualizedList.js',
...
var VirtualizedList = (_temp = _class = function (_React$PureComponent) {
  ...
  _createClass(VirtualizedList, [{
    ...
    value: function _renderDebugOverlay() {
      ...
      return React.createElement(
        View,
        { style: _extends({}, baseStyle, { bottom: 0, width: 20, borderColor: 'blue', borderWidth: 1 }), __source: {
            fileName: _jsxFileName,
            lineNumber: 551
          }
        },
  ...
  this._onScroll = function (e) {
    ...
    var itemCount = getItemCount(data);
    if (_this3.state.last === itemCount - 1 && distanceFromEnd < onEndReachedThreshold * visibleLength && (_this3._hasDataChangedSinceEndReached || _this3._scrollMetrics.contentLength !== _this3._sentEndForContentLength)) {
      _this3._hasDataChangedSinceEndReached = false;
...
var CellRenderer = _wrapComponent('CellRenderer')(function (_React$Component) {
  ...
  function CellRenderer() {
    ...
    return _possibleConstructorReturn(this, (CellRenderer.__proto__ || Object.getPrototypeOf(CellRenderer)).apply(this, arguments));
  }
