...
var _reactTransformHmrLibIndexJs2 = (0, _index2.default)({
  filename: '/mnt/c/Users/Daniel/Naviago-RN-Frontend/node_modules/expo/src/Video.js',
...
var Video = _wrapComponent('Video')((_temp = _class = function (_Component) {
  ...
  return Video;
}(_react2.Component), _class.RESIZE_MODE_CONTAIN = 'contain', _class.RESIZE_MODE_COVER = 'cover', _class.RESIZE_MODE_STRETCH = 'stretch', _temp));
...
Video.propTypes = _extends({
  ...
  posterSource: _react2.PropTypes.oneOfType([_react2.PropTypes.shape({
    uri: _react2.PropTypes.string
  }), _react2.PropTypes.number]),

  callback: _react2.PropTypes.func,
  onLoadStart: _react2.PropTypes.func,
  onLoad: _react2.PropTypes.func,
  onError: _react2.PropTypes.func,
  onIOSFullscreenUpdate: _react2.PropTypes.func,
  onReadyForDisplay: _react2.PropTypes.func,

  useNativeControls: _react2.PropTypes.bool,
  resizeMode: _react2.PropTypes.string,
  usePoster: _react2.PropTypes.bool,

  status: _react2.PropTypes.shape({
    progressUpdateIntervalMillis: _react2.PropTypes.number,
    positionMillis: _react2.PropTypes.number,
    shouldPlay: _react2.PropTypes.bool,
    rate: _react2.PropTypes.number,
    shouldCorrectPitch: _react2.PropTypes.bool,
    volume: _react2.PropTypes.number,
    isMuted: _react2.PropTypes.bool,
    isLooping: _react2.PropTypes.bool
  }),
  progressUpdateIntervalMillis: _react2.PropTypes.number,
  positionMillis: _react2.PropTypes.number,
  shouldPlay: _react2.PropTypes.bool,
